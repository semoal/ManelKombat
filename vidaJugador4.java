 ...
 */
public class vidaJugador4 extends Jugador4 {
 int vidaInicial = 100;
 int dañoPuñetazo = 10;
 int dañoPatada = 15;
 int dañoEspecial = 35;
 boolean fin = false;
 public void act() {
  if (getWorld().getObjects(Jugador4.class).get(0).enemy != null) {
 ...
 public void barraVida(int vidaInicial) {
  ...
  setLocation((getWorld().getObjects(Jugador4.class).get(0).getX()), (getWorld().getObjects(Jugador4.class).get(0).getY() - 100));
 }

 public void puñetazo() {
  String checker = ((getWorld().getObjects(Jugador4.class).get(0).enemy).toString());
